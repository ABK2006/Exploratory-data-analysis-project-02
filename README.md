...
Here is a detailed draft and code structure to help you answer all six questions. You can use these snippets to build your plot1.R through plot6.R files.
